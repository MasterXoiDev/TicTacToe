...
const HeaderAuth = () => {
    ...
    // console.log(user);
    const {cardItems, favoriteList, photos} = useGalary()
        ...
        <div className='flex items-center justify-center p-4 bg-white shadow-md'>
            ...
            <div className='flex items-center gap-5 ml-auto mr-5'>
                <span className='relative w-8'>
                    <svg className='w-max-full' width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
